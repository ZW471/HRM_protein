...
def cleanup_cuda_cache():
    """Clean up CUDA cache and memory."""
...
@hydra.main(config_path="config", config_name="cfg_pretrain_visual", version_base=None)
def launch(hydra_config: DictConfig):
    # Setup signal handlers and cleanup at exit
    setup_signal_handlers()
    atexit.register(cleanup_cuda_cache)
